...
const figure = `M 377 105 C 356 104 341 106 323 110 C 286 107 245 124 230 146 L 218 169 L 194 181 L 205 194 L 220 198 C 217 224 226 254 244 274 L 261 302 C 237 322 227 352 218 382 C 202 414 191 456 187 481 Q 185 511 218 522 L 258 535 Q 246 578 213 613 C 174 656 151 691 112 726 L 67 761 L 32 787 Q 62 807 91 811 L 78 825 L 85 849 L 94 868 L 106 884 Q 149 906 193 909 Q 212 965 235 1001 Q 246 1020 278 1023 L 262 1052 L 247 1081 L 230 1104 Q 218 1116 213 1125 Q 205 1134 192 1142 Q 182 1145 186 1151 Q 192 1156 211 1158 Q 230 1162 248 1153 Q 269 1142 283 1123 L 302 1092 Q 347 1083 366 1068 L 393 1081 L 395 1124 L 396 1161 Q 397 1183 422 1196 L 450 1214 Q 476 1228 496 1212 Q 508 1200 494 1184 L 468 1155 L 458 1128 L 456 1091 Q 482 1085 492 1055 L 506 993 L 510 950 L 511 917 Q 532 923 534 911 L 534 891 Q 533 880 529 870 L 525 850 L 520 830 L 518 810 L 517 790 L 513 772 Q 512 768 521 760 L 536 740 L 550 720 L 563 700 L 575 680 L 585 660 L 593 640 L 601 620 Q 604 612 597 605 L 592 600 Q 605 614 619 623 Q 630 633 640 633 Q 650 631 661 615 Q 670 598 667 582 L 652 566 L 630 552 L 609 536 C 596 496 585 458 568 424 L 556 405 Q 576 369 573 326 L 568 278 Q 563 241 540 216 L 543 206 L 537 190 L 532 180 L 524 170 L 514 160 L 502 150 L 490 145 L 487 130 Q 485 120 479 111 Q 469 103 457 100 Q 434 94 413 98 Q 400 100 390 107 Z`;
...
const staff = 'M 473 1117 L 610 647 L 646 551 L 675 450 L 703 349 L 725 278 C 731 254 735 233 742 218 C 748 204 756 195 768 195 C 781 195 788 205 790 219 C 793 236 786 255 776 263 C 770 267 761 266 758 259 C 757 252 762 247 768 247 C 774 237 777 224 773 215 C 771 208 766 207 761 211 C 751 220 746 239 743 254 L 720 350 L 692 452 L 663 553 L 632 652 L 500 1117 Q 496 1128 486 1127 Q 475 1128 473 1117 Z';
...
export function Artwork({ motion, original, depth, focus, cloudSpeed }: {motion:boolean;original:boolean;depth:number;focus:boolean;cloudSpeed:number}) {
  ...
  return <div ref={root} className={`art-interaction ${original?'is-original':''} ${focus&&!original?'has-focus':''}`} tabIndex={0} role="region" aria-label="The Good Shepherd interactive artwork. Move your pointer, drag with a finger, or use the arrow keys to explore depth."
    ...
    <div className="landscape-space" aria-hidden="true">
      ...
      <img className="landscape-image landscape-foreground" src="/art/landscape-wide.png" alt="" draggable="false"/>
    </div>
